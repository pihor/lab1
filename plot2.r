#PLOT 2
# Data reading
dataframe <- read.csv("E:/RStudio/lab5/household_power_consumption.txt", header=TRUE, dec=".",sep=";")
...
# Save image
dev.copy(device = png, filename = 'E:/RStudio/lab5/second.png', width = 480, height = 480)
dev.off ()